...
const FreezingDrizzle:React.FC<IIconProps> = ({width,height}) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#9FA7AE"/>
            <path d="M14.4741 14.1001L13.4741 16" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M11 14L10 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M8 14L7 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M3.13397 15.8089L2.24134 13.6965L4.20566 13.7815L3.13397 15.8089Z" fill="#9FA7AE"/>
        </svg>
    );
};
