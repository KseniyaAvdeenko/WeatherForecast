...
const FreezingRain: React.FC<IIconProps> = ({width, height}) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#9FA7AE"/>
            <path d="M14.0034 14L13.0034 16.8498" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M11.0034 14L10.0034 16.8498" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M8.00342 14L7.00342 16.8498" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M5.13397 16.754L4.27201 13.9328L6.23632 14.0178L5.13397 16.754Z" fill="#9FA7AE"/>
        </svg>
    );
};
