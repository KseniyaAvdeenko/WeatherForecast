...
const LightRain: React.FC<IIconProps> = ({width, height}) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#9FA7AE"/>
            <path d="M10 14L8 17" stroke="#05BBF4" strokeLinecap="round"/>
            <path d="M12 14L10 17" stroke="#05BBF4" strokeLinecap="round"/>
        </svg>
    );
};
