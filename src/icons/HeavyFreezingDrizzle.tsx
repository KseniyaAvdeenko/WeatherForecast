...
const HeavyFreezingDrizzle: React.FC<IIconProps> = ({width, height}) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#9FA7AE"/>
            <path d="M15 14L14 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M11 14L10 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M13 14L12 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M9 14L8 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M7 14L6 15.8999" stroke="#9FA7AE" strokeLinecap="round"/>
            <path d="M4.13397 15.8089L3.24134 13.6965L5.20566 13.7815L4.13397 15.8089Z" fill="#9FA7AE"/>
        </svg>
    );
};
