...
const HeavyRain: React.FC<IIconProps> = ({width, height}) => {
    return (
        <svg width={width} height={height} viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#9FA7AE"/>
            <path d="M5 14L3 17" stroke="#05BBF4" strokeLinecap="round"/>
            <path d="M8 14L6 17" stroke="#05BBF4" strokeLinecap="round"/>
            <path d="M11 14L9 17" stroke="#05BBF4" strokeLinecap="round"/>
            <path d="M14 14L12 17" stroke="#05BBF4" strokeLinecap="round"/>
        </svg>
    );
};
